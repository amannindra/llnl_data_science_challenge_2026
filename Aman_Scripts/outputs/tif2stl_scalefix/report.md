...
Generated 2026-07-28T17:08:07Z in 117.0 s.
...
- Implied voxel pitch: 57.738 um (nominal 58.1 um, deviation -0.62%)
- STL modelling orientation: `+z+x+y` ('+z+x+y' requested), CT hit fraction 0.3048 over 1,600,000 sampled surface points; runner-up `-y-z+x` at 0.4152

## Agreement

| metric | value |
| --- | --- |
| lattice-window Dice | 0.4263 |
| lattice-window IoU | 0.2709 |
| lattice-window CT within design (+1 cell) | 0.7540 |
| lattice-window design realized in CT (+1 cell) | 0.5669 |
| full-grid strict Dice | 0.3629 |
| full-grid strict IoU | 0.2217 |
| full-grid CT within design (+1 cell) | 0.5115 |
| full-grid design realized in CT (+1 cell) | 0.5666 |
| CT material volume | 11,290 mm^3 |
| STL solid volume | 24,325 mm^3 |
| voxelized STL volume | 13,462 mm^3 |

## Gates

- **PASS** registration_rms: 3.327e-12 vox <= 1.0
- **PASS** lattice_window_dice: 0.4263 >= 0.0 (full grid: 0.3629)
- **PASS** surface_points_in_grid: outside fraction 0.1338 <= 0.15
