...
CANDIDATE_ORDER = ["missing", "broken", "uncertain", "intact"]
...
def thickness_histogram_figure(
    ...
    *,
    ...
    if thin_cutoff_um is not None:
        figure.add_vline(
            x=thin_cutoff_um, line_color=CHART_CLASS_COLORS["uncertain"], line_dash="dash",
            annotation_text="Lower-tail reference", annotation_position="top left",
        )
